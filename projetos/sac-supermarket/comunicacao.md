...
- Endereços e credenciais permanecem fora do Git e são configurados no ambiente de envio.
- O registro de envio ou a mensagem arquivada deve ser referenciado como evidência quando disponível.
...
1. data de referência, fase e período coberto;
2. resumo executivo;
3. atividades realizadas;
4. principais decisões confirmadas;
...
- confirmar a frequência regular do status;
- confirmar se há aprovação prévia para o envio regular;
- configurar remetente e Send API key do ZeptoMail no Windows;
- realizar envio de teste e guardar a evidência.
